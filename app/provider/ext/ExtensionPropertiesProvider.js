...
var processProps = require('bpmn-js-properties-panel/lib/provider/bpmn/parts/ProcessProps'),
    ...
    codeProps = require('./parts/CodeEntryProps'),
    variableProps = require('./parts/VariableEntryProps'),
    signalProps = require('./parts/SignalEntryProps'),
    executeNowProps = require('./parts/ExecuteNowProps');
...
function createGeneralTabGroups(element, bpmnFactory, elementRegistry) {
  ...
  executeNowProps(generalGroup,element, bpmnFactory);
  variableProps(generalGroup,element, bpmnFactory);
  codeProps(generalGroup,element, bpmnFactory);
  signalProps(generalGroup,element,bpmnFactory)
...
function createMagicTabGroups(element, elementRegistry) {
  ...
  executeNowProps(blackMagicGroup, element);
