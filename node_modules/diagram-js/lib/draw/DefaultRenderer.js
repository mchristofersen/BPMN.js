...
function DefaultRenderer(eventBus, styles) {
  ...
  this.CONNECTION_STYLE = styles.style([ 'no-fill' ], { strokeWidth: 5, stroke: '#607D8B' ,filter:"url(#drop-shadow)"});
  this.SHAPE_STYLE = styles.style({ fill: 'white', stroke: '#607D8B', strokeWidth: 2  ,filter:"url(#drop-shadow)" });
}
