...
function BpmnRenderer(eventBus, styles, pathMap, priority) {
  ...
  var handlers = this.handlers = {
    ...
    'bpmn:LinkEventDefinition': function(p, event, isThrowing) {
      ...
      var fill = isThrowing ? '#D32F2F' : '#4CAF50';
    ...
    'bpmn:SignalEventDefinition': function(p, event, isThrowing) {
      ...
      var fill = isThrowing ? '#000000' : 'none';
    ...
    'bpmn:SendTask': function(p, element) {
      var task = drawRect(p, element.width, element.height, TASK_BORDER_RADIUS, {
        strokeWidth: 2,
        fill: '#B2EBF2',
        stroke: 'black'
      });
    ...
    'bpmn:ScriptTask': function(p, element, attrs) {
      var rect = drawRect(p, element.width, element.height, TASK_BORDER_RADIUS, {
        strokeWidth: 1,
        fill: '#FFF9C4',
        stroke: 'black'
    ...
    'bpmn:SubProcess': function(p, element, attrs) {
      ...
      attrs = assign({ fillOpacity: 0.95,stroke:"#000000" }, attrs);
