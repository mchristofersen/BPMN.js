...
ContextPadProvider.prototype.getContextPadEntries = function(element) {
  ...
  if (isAny(businessObject, ["bpmn:UserTask"])){
    assign(actions, {
      'edit': {
        group: 'edit',
  ...
  if (isAny(businessObject, ["bpmn:SubProcess"])){
    assign(actions, {
      'expand': {
        ...
        title: translate('View Subflow'),
        action: {
          click: function openSubflow(e){
            bus.fire("subflow.view",businessObject.flowId)
          }
        }
      }
    });
