...
PaletteProvider.prototype.getPaletteEntries = function(element) {
  ...
  assign(actions, {
    ...
    'create.intermediate-event-catch': createAction('bpmn:IntermediateCatchEvent', 'event',
      'bpmn-icon-intermediate-event-catch-signal', translate('Create IntermediateCatchEvent/BoundaryEvent')
    ),
  ...
  'create.service-task': createAction(
    ...
    'create.subprocess-collapsed': createAction(
      'bpmn:SubProcess', 'activity', 'bpmn-icon-subprocess-collapsed', translate('Create collapsed SubProcess'),
      { isExpanded: false }
    ),
